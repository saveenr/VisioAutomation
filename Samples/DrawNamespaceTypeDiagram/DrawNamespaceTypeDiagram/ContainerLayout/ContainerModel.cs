...
namespace ContainerLayout
{
    class ContainerModel
    {
        ...
        public void PerformLayout()
        {
            ...
            for (int container = 0; container< this.Containers.Count; container++)
            {
                ...
                for (int ri=0;ri<ct.ContainerItems.Count;ri++)
                {
                    ...
                    var rect = new VAM.Rectangle(left, bottom, right, top);
            ...
            foreach (var ct in this.Containers)
            {
                ...
                ct.Rectangle = new VAM.Rectangle(min_left, min_bottom, max_right, max_top);
            }
        ...
        public void Render(IVisio.Application app)
        {
            ...
            // load the special container stencil
            var basic_stencil = VAM.DrawingHelper.OpenStencil(docs, "basic_u.vss");
            ...
            if (this.LayoutOptions.RenderWithShapes == true )
            {
                ...
                short[] ct_shapeids = VAM.DrawingHelper.DropMaster(page, basic_master, ct_rects);
            ...
            short[] shapeids = VAM.DrawingHelper.DropMaster(page, basic_master, rects);
            ...
            var update = new VAM.SIDSRCUpdate();
            foreach (var ct in container_model.Containers)
            {
