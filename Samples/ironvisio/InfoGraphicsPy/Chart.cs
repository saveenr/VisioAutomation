...
namespace InfoGraphicsPy
{
    public class Chart
    {
        ...
        public List<VA.DOM.Master> DrawRects(VA.DOM.Document dom, IList<VA.Drawing.Rectangle> rects, IVisio.Master rectmaster)
        {
        ...
        public List<IVisio.Shape> DrawRects(IList<VA.Drawing.Rectangle> rects, IVisio.Master rectmaster, IVisio.Page page)
        {
            var dom_shapes = new List<VA.DOM.Master>();
