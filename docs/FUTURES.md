...
- **[`futures/identity.md`](futures/identity.md)** — Dev team identity. Items: *Transition dev team identity from "Saveen" to "SevenPens"* (8 axes total; axes 1, 2, 4, 6, 7, 8 done as of 2026-05-07. Axes 3 (PSGallery publishing identity) and 5 (hosting URLs, plan agreed, gated on external moves) remain).
