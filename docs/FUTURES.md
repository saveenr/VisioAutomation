...
- **[`futures/identity.md`](futures/identity.md)** — Dev team identity. Items: *Transition dev team identity from "Saveen" to "SevenPens"* (8 axes — commit identity, nuget publishing, PSGallery publishing, displayed authorship, hosting URLs, code references, legal copyright, frozen test fixtures).
