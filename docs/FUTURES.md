...
- **NOT worth chasing for this codebase:**
  ...
  - **`Microsoft.Testing.Platform` migration today.** It's the long-term replacement for VSTest, supported by MSTest / xUnit / NUnit, but the ecosystem is still maturing. Naturally pairs with the xUnit decision in Phase 3, not before.
