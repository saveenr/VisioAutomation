...
namespace TestVisioAutomation
{
    ...
    public class ScriptingExportTests : VisioAutomationTest
    {
        ...
        [TestMethod]
        public void Scripting_Test_ExportXAML()
        {
            var ss = GetScriptingSession();
            ...
            string output_filename = TestCommon.Globals.Helper.GetTestMethodOutputFilename(".xaml");

            if (System.IO.File.Exists(output_filename))
            {
                System.IO.File.Delete(output_filename);
            }
            ss.Export.ExportSelectionToXAML(output_filename);
