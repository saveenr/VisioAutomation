...
namespace TestVisioAutomation
{
    ...
    public class ScriptingPageTests : VisioAutomationTest
    {
        ...
        public void Scripting_Page_Navigation()
        {
            ...
            ss.Page.GoTo(VA.Scripting.PageNavigation.FirstPage);
            Assert.AreEqual(page1, ss.Page.Get());
            ss.Page.GoTo(VA.Scripting.PageNavigation.LastPage);
            Assert.AreEqual(page3, ss.Page.Get());
            ss.Page.GoTo(VA.Scripting.PageNavigation.PreviousPage);
            Assert.AreEqual(page2, ss.Page.Get());
            ss.Page.GoTo(VA.Scripting.PageNavigation.NextPage);
            Assert.AreEqual(page3, ss.Page.Get());
