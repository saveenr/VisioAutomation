...
namespace TestVisioAutomation
{
    ...
    public class StencilTests : VisioAutomationTest
    {
        ...
        public void RackMountedEquipment_1()
        {
            ...
            VA.CustomProperties.CustomPropertyHelper.SetCustomProperty(rack_shape, "UCount", total_height.ToString());
            ...
            foreach (var item in items)
            {
                ...
                VA.CustomProperties.CustomPropertyHelper.UpdateCustomProperty(shape1, "UCount", item.ucount.ToString());
