...
namespace TestVisioAutomation
{
    ...
    public class DOM_Basic_Tests : VisioAutomationTest
    {
        ...
        public void DropLine()
        {
            var doc = this.GetNewDoc();
            var dompage = new VA.DOM.Page();
            var dom_line_0 = dompage.ShapeList.DrawLine(1, 1, 3, 3);
            var page = dompage.Render(doc);
        ...
        public void DropBezier()
        {
            var doc = this.GetNewDoc();
            var dompage = new VA.DOM.Page();
            var dom_bez_0 = dompage.ShapeList.DrawBezier(new double[] { 1, 2, 3, 3, 6, 3, 3, 4 });
        ...
        public void DropMaster()
        {
            ...
            var dom_master_0 = dompage.ShapeList.Drop(master1, 3, 3);
            var dom_master_1 = dompage.ShapeList.Drop("Rectangle", "basic_u.vss", 5, 5);
        ...
        public void Connect()
        {
            ...
            var dom_master_0 = dompage.ShapeList.Drop(master1, 3, 3);
            var dom_master_1 = dompage.ShapeList.Drop(master1, 6, 5);
            var dc = dompage.ShapeList.Connect(master2, dom_master_0, dom_master_1);
        ...
        public void ConnectDeferred()
        {
            ...
            var dom_master_0 = dompage.ShapeList.Drop("Rectangle", "basic_u.vss", 3, 3);
            var dom_master_1 = dompage.ShapeList.Drop("Rectangle", "basic_u.vss", 6, 5);
            var dc = dompage.ShapeList.Connect("Dynamic Connector", "basic_u.vss", dom_master_0, dom_master_1);
        ...
        public void DropUnknownMaster()
        {
            var doc = this.GetNewDoc();
            var dompage = new VA.DOM.Page();
            var dom_master_0 = dompage.ShapeList.Drop("RectangleXXX", "basic_u.vss", 3, 3);
        ...
        public void DropUnknownStencil()
        {
            var doc = this.GetNewDoc();
            var dompage = new VA.DOM.Page();
            var dom_master_0 = dompage.ShapeList.Drop("RectangleXXX", "basic_uXXX.vss", 3, 3);
        ...
        public void VerifyDropVersusDraw()
        {
            ...
            var dropped_shape = dompage.ShapeList.Drop("Rectangle", "basic_u.vss", rect);
            var drawn_shape = dompage.ShapeList.DrawRectangle(rect);
            var page = dompage.Render(doc);
        ...
        public void VerifyDropVersusDraw2()
        {
            ...
            var dropped_shape0 = dompage.ShapeList.Drop("Rectangle", "basic_u.vss", rect0);
            var drawn_shape0 = dompage.ShapeList.DrawRectangle(rect0);

            var dropped_shape1 = dompage.ShapeList.Drop("Rectangle", "basic_u.vss", rect1);
            var drawn_shape1 = dompage.ShapeList.DrawRectangle(rect1);
