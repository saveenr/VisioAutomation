...
namespace TestVisioAutomation
{
    ...
    public class DOM_Draw_Tests : VisioAutomationTest
    {
        ...
        {
            var m = new VA.Text.Markup.TextElement("Normal Text");
            m.TextCharFormat.CharStyle = VA.Text.CharStyle.Bold;
            var page1 = this.GetNewPage(new VA.Drawing.Size(5, 5));
            var s0 = page1.DrawRectangle(0, 0, 4, 4);
            m.SetText(s0);
            page1.Delete(0);
        ...
        {
            var m = new VA.Text.Markup.TextElement("Normal Text");
            m.TextCharFormat.CharStyle = VA.Text.CharStyle.Italic;
            var page1 = this.GetNewPage(new VA.Drawing.Size(5, 5));
            var s0 = page1.DrawRectangle(0, 0, 4, 4);
            m.SetText(s0);
            page1.Delete(0);
        ...
        public void Render_Markup_Simple_Font_Multiple()
        {
            var m = new VA.Text.Markup.TextElement("Normal Text");
            m.TextCharFormat.Font = "Impact";
            m.TextCharFormat.Color = new VA.Drawing.ColorRGB(0xff0000);
            var page1 = this.GetNewPage(new VA.Drawing.Size(5, 5));
            var s0 = page1.DrawRectangle(0, 0, 4, 4);
            m.SetText(s0);
            page1.Delete(0);
        ...
        public void Markup_Overlap_Multiple()
        {
            ...
            t1.TextCharFormat.Font = "Segoe UI";
            var t2 = t1.AppendElement("Italic");
            t2.TextCharFormat.CharStyle = VA.Text.CharStyle.Italic;

            var t3 = t2.AppendElement("Italic");
            t3.TextCharFormat.CharStyle = VA.Text.CharStyle.Bold;

            var t4 = t2.AppendElement("Bold Italic");
            t4.TextCharFormat.CharStyle = VA.Text.CharStyle.Bold | VA.Text.CharStyle.Italic;
