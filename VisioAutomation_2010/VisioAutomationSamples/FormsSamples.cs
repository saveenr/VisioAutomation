...
namespace VisioAutomationSamples
{
    ...
    public static class FormsSamples
    {
        public static void MonitorResolutions()
        {
            ...
            {
                new ResolutionInfo("VGA","4:03",640,480),
                new ResolutionInfo("SVGA","4:03",800,600),
                new ResolutionInfo("WSVGA","~17:10",1024,600),
                new ResolutionInfo("XGA","4:03",1024,768),
                new ResolutionInfo("XGA+","4:03",1152,864),
                new ResolutionInfo("WXGA","16:09",1280,720),
                new ResolutionInfo("WXGA","5:03",1280,768),
                new ResolutionInfo("WXGA","16:10",1280,800),
                new ResolutionInfo("SXGA–(UVGA)","4:03",1280,960),
                new ResolutionInfo("SXGA","5:04",1280,1024),
                new ResolutionInfo("HD","~16:9",1360,768),
                new ResolutionInfo("HD","~16:9",1366,768),
                new ResolutionInfo("SXGA+","4:03",1400,1050),
                new ResolutionInfo("WXGA+","16:10",1440,900),
                new ResolutionInfo("HD+","16:09",1600,900),
                new ResolutionInfo("UXGA","4:03",1600,1200),
                new ResolutionInfo("WSXGA+","16:10",1680,1050),
                new ResolutionInfo("FHD","16:09",1920,1080),
                new ResolutionInfo("WUXGA","16:10",1920,1200),
                new ResolutionInfo("QWXGA","16:09",2048,1152),
                new ResolutionInfo("WQHD","16:09",2560,1440),
                new ResolutionInfo("WQXGA","16:10",2560,1600),
                new ResolutionInfo("Unknown","3:04",768,1024),
                new ResolutionInfo("Unknown","16:09",1093,614),
            ...
            renderer.AddShape(5, 0.5, "Resolutions");
            ...
            {
                renderer.AddShape(10, 1, group.Key);
                renderer.Linefeed(0.5);
