namespace VSamples.Layouts
{
    public static class BoxLayout2Samples1
    {
        public static void BoxLayout_SimpleCases()
        {
            ...
            layout1.Root = new VisioAutomation.Models.Layouts.Box.Container(VisioAutomation.Models.Layouts.Box.Direction.BottomToTop);
            ...
            layout2.Root = new VisioAutomation.Models.Layouts.Box.Container(VisioAutomation.Models.Layouts.Box.Direction.BottomToTop, 3, 5);
            ...
            layout3.Root = new VisioAutomation.Models.Layouts.Box.Container(VisioAutomation.Models.Layouts.Box.Direction.TopToBottom, 3, 5);
            ...
            layout4.Root = new VisioAutomation.Models.Layouts.Box.Container(VisioAutomation.Models.Layouts.Box.Direction.RightToLeft, 3, 5);
            ...
            layout5.Root = new VisioAutomation.Models.Layouts.Box.Container(VisioAutomation.Models.Layouts.Box.Direction.BottomToTop, 3, 0);
            ...
            layout6.Root = new VisioAutomation.Models.Layouts.Box.Container(VisioAutomation.Models.Layouts.Box.Direction.LeftToRight, 0, 5);
