...
{
    [MUT.TestClass]
    public class DomTests : Framework.VTest
    {
        ...
        [MUT.TestMethod]
        public void RenderPageToDocument()
        {
        ...
        [MUT.TestMethod]
        public void RenderDocumentToApplication()
        {
        ...
        [MUT.TestMethod]
        public void ConnectShapes_PreloadedMasters_ConnectsTwoNodes()
        {
            var doc = this.GetNewDoc();
            var page_node = new VADOM.Page();
        ...
        [MUT.TestMethod]
        public void ConnectShapes_DeferredMasterLoad_LoadsStencilsAtRenderTime()
        {
