...
namespace VisioPowerShell.Commands.VisioShapeCells
{
    ...
    public class SetVisioShapeCells : VisioCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var target_shapes = this.Shapes ?? this.Client.Selection.GetShapes(new VisioScripting.TargetSelection());
            ...
            using (var undoscope = this.Client.Undo.NewUndoScope(new VisioScripting.TargetActiveApplication(), nameof(SetVisioShapeCells)))
            {
