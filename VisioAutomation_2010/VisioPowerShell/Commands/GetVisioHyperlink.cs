...
{
    [SMA.Cmdlet(SMA.VerbsCommon.Get, VisioPowerShell.Commands.Nouns.VisioHyperlink)]
    public class GetVisioHyperlink : VisioCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var dic = this.Client.Hyperlink.GetHyperlinkCells(targets, CellValueType.Formula);
