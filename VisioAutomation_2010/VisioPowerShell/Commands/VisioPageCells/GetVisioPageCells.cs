...
namespace VisioPowerShell.Commands.VisioPageCells
{
    ...
    public class GetVisioPageCells: VisioCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            foreach (var target_page in target_pages.Items)
            {
            ...
            for (int row_index = 0; row_index < target_pages.Items.Count; row_index++)
            {
                result_dt.Rows[row_index][pageindex_col.ColumnName] = target_pages.Items[row_index].Index;
            }
