...
namespace VisioScripting.Models
{
    public class PageDimensions
    {
        ...
        public static List<PageDimensions> Get_PageDimensions(IList<IVisio.Page> pages)
        {
            ...
            var col_PageHeight = query.Columns.Add(VisioAutomation.Core.SrcConstants.PageHeight);
            var col_PageWidth = query.Columns.Add(VisioAutomation.Core.SrcConstants.PageWidth);
            var col_PrintBottomMargin =
                query.Columns.Add(VisioAutomation.Core.SrcConstants.PrintBottomMargin);
            var col_PrintTopMargin =
                query.Columns.Add(VisioAutomation.Core.SrcConstants.PrintTopMargin);
            var col_PrintLeftMargin =
                query.Columns.Add(VisioAutomation.Core.SrcConstants.PrintLeftMargin);
            var col_PrintRightMargin =
                query.Columns.Add(VisioAutomation.Core.SrcConstants.PrintRightMargin);
