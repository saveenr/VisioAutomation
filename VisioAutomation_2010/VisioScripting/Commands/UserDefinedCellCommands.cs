...
namespace VisioScripting.Commands
{
    public class UserDefinedCellCommands : CommandSet
    {
        ...
        public void DeleteUserDefinedCellsByName(Models.TargetShapes targets, string name)
        {
            ...
            using (var undoscope = this._client.Application.NewUndoScope(nameof(DeleteUserDefinedCellsByName)))
            {
        ...
        public void SetUserDefinedCell(Models.TargetShapes targets, Models.UserDefinedCell cell)
        {
            ...
            using (var undoscope = this._client.Application.NewUndoScope(nameof(SetUserDefinedCell)))
            {
                foreach (var shape in targets.Shapes)
                {
