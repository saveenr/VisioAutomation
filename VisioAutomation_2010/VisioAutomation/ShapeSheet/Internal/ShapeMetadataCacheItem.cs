...
namespace VisioAutomation.ShapeSheet.Internal
{
    internal class ShapeMetadataCacheItem
    {
        ...
        public VisioAutomation.ShapeSheet.Data.DataColumns ColumnGroup { get; }

        // The RowCount is the data that is being cached
        public int RowCount { get; }

        internal ShapeMetadataCacheItem(short shapeid, IVisio.VisSectionIndices sec_index, VisioAutomation.ShapeSheet.Data.DataColumns sec_cols,
            int numrows)
        {
