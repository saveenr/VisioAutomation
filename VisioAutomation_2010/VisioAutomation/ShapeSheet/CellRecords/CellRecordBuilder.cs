...
namespace VisioAutomation.ShapeSheet.CellRecords
{
    ...
    public abstract class CellRecordBuilder2<TREC> where TREC : CellRecord, new()
    {
        public readonly CellRecordQueryType CellRecordQueryType;
        protected Query.CellQuery cellquery;
        protected Query.SectionQuery sectionquery;
        ...
        private CellRecordBuilder2()
        {
            this.cellquery = null;
            this.sectionquery = null;
        }

        protected CellRecordBuilder2(CellRecordQueryType cell_record_query_type, System.Func<ROW,COLS, TREC> func_row_to_rec)
        {
