...
namespace VisioAutomation.ShapeSheet.Query
{
    public class MultiSectionQuery
    {
        ...
        private MultiSectionQueryCache _sectioncache;
        ...
        private void CacheSectionInfoForAllShapes(SurfaceTarget surface, IList<int> shape_ids)
        {
            ...
            {
                this._sectioncache = new MultiSectionQueryCache(0);
            }
            this._sectioncache = new MultiSectionQueryCache();
        ...
        private MultiSectionOuputList<T> _create_outputs_for_shapes<T>(IList<int> shapeids, MultiSectionQueryCache sectioncache, VASS.Internal.ArraySegmentReader<T> segReader)
        {
