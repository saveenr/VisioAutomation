...
{
    public class PageLayoutCells : VASS.CellGroups.CellGroupSingleRow
    {
        ...
        public static PageLayoutCells GetCells(Microsoft.Office.Interop.Visio.Shape shape, VASS.CellValueType type)
        {
