...
namespace VisioAutomation.Pages
{
    public class PageCells : VA.ShapeSheet.CellGroups.CellGroup
    {
        ...
        {
            yield return srcvaluepair(ShapeSheet.SRCConstants.PageLeftMargin, this.PageLeftMargin.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.CenterX, this.CenterX.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.CenterY, this.CenterY.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.OnPage, this.OnPage.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PageBottomMargin, this.PageBottomMargin.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PageRightMargin, this.PageRightMargin.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PagesX, this.PagesX.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PagesY, this.PagesY.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PageTopMargin, this.PageTopMargin.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PaperKind, this.PaperKind.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PrintGrid, this.PrintGrid.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PrintPageOrientation, this.PrintPageOrientation.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.ScaleX, this.ScaleX.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.ScaleY, this.ScaleY.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PaperSource, this.PaperSource.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.DrawingScale, this.DrawingScale.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.DrawingScaleType, this.DrawingScaleType.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.DrawingSizeType, this.DrawingSizeType.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.InhibitSnap, this.InhibitSnap.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PageHeight, this.PageHeight.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PageScale, this.PageScale.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PageWidth, this.PageWidth.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.ShdwObliqueAngle, this.ShdwObliqueAngle.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.ShdwOffsetX, this.ShdwOffsetX.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.ShdwOffsetY, this.ShdwOffsetY.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.ShdwScaleFactor, this.ShdwScaleFactor.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.ShdwType, this.ShdwType.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.UIVisibility, this.UIVisibility.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.XGridDensity, this.XGridDensity.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.XGridOrigin, this.XGridOrigin.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.XGridSpacing, this.XGridSpacing.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.XRulerDensity, this.XRulerDensity.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.XRulerOrigin, this.XRulerOrigin.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.YGridDensity, this.YGridDensity.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.YGridOrigin, this.YGridOrigin.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.YGridSpacing, this.YGridSpacing.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.YRulerDensity, this.YRulerDensity.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.YRulerOrigin, this.YRulerOrigin.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.AvenueSizeX, this.AvenueSizeX.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.AvenueSizeY, this.AvenueSizeY.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.BlockSizeX, this.BlockSizeX.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.BlockSizeY, this.BlockSizeY.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.CtrlAsInput, this.CtrlAsInput.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.DynamicsOff, this.DynamicsOff.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.EnableGrid, this.EnableGrid.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineAdjustFrom, this.LineAdjustFrom.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineAdjustTo, this.LineAdjustTo.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineJumpCode, this.LineJumpCode.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineJumpFactorX, this.LineJumpFactorX.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineJumpFactorY, this.LineJumpFactorY.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineJumpStyle, this.LineJumpStyle.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineRouteExt, this.LineRouteExt.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineToLineX, this.LineToLineX.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineToLineY, this.LineToLineY.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineToNodeX, this.LineToNodeX.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.LineToNodeY, this.LineToNodeY.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PageLineJumpDirX, this.PageLineJumpDirX.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PageLineJumpDirY, this.PageLineJumpDirY.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PageShapeSplit, this.PageShapeSplit.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PlaceDepth, this.PlaceDepth.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PlaceFlip, this.PlaceFlip.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PlaceStyle, this.PlaceStyle.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.PlowCode, this.PlowCode.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.ResizePage, this.ResizePage.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.RouteStyle, this.RouteStyle.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.AvoidPageBreaks, this.AvoidPageBreaks.Formula);
            yield return srcvaluepair(ShapeSheet.SRCConstants.DrawingResizeType, this.DrawingResizeType.Formula);
        }
