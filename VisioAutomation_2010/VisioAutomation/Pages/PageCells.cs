...
namespace VisioAutomation.Pages
{
    public class PageCells : VA.ShapeSheet.CellGroups.CellGroup
    {
        ...
        {
            yield return foo(ShapeSheet.SRCConstants.PageLeftMargin, this.PageLeftMargin.Formula);
            yield return foo(ShapeSheet.SRCConstants.CenterX, this.CenterX.Formula);
            yield return foo(ShapeSheet.SRCConstants.CenterY, this.CenterY.Formula);
            yield return foo(ShapeSheet.SRCConstants.OnPage, this.OnPage.Formula);
            yield return foo(ShapeSheet.SRCConstants.PageBottomMargin, this.PageBottomMargin.Formula);
            yield return foo(ShapeSheet.SRCConstants.PageRightMargin, this.PageRightMargin.Formula);
            yield return foo(ShapeSheet.SRCConstants.PagesX, this.PagesX.Formula);
            yield return foo(ShapeSheet.SRCConstants.PagesY, this.PagesY.Formula);
            yield return foo(ShapeSheet.SRCConstants.PageTopMargin, this.PageTopMargin.Formula);
            yield return foo(ShapeSheet.SRCConstants.PaperKind, this.PaperKind.Formula);
            yield return foo(ShapeSheet.SRCConstants.PrintGrid, this.PrintGrid.Formula);
            yield return foo(ShapeSheet.SRCConstants.PrintPageOrientation, this.PrintPageOrientation.Formula);
            yield return foo(ShapeSheet.SRCConstants.ScaleX, this.ScaleX.Formula);
            yield return foo(ShapeSheet.SRCConstants.ScaleY, this.ScaleY.Formula);
            yield return foo(ShapeSheet.SRCConstants.PaperSource, this.PaperSource.Formula);
            yield return foo(ShapeSheet.SRCConstants.DrawingScale, this.DrawingScale.Formula);
            yield return foo(ShapeSheet.SRCConstants.DrawingScaleType, this.DrawingScaleType.Formula);
            yield return foo(ShapeSheet.SRCConstants.DrawingSizeType, this.DrawingSizeType.Formula);
            yield return foo(ShapeSheet.SRCConstants.InhibitSnap, this.InhibitSnap.Formula);
            yield return foo(ShapeSheet.SRCConstants.PageHeight, this.PageHeight.Formula);
            yield return foo(ShapeSheet.SRCConstants.PageScale, this.PageScale.Formula);
            yield return foo(ShapeSheet.SRCConstants.PageWidth, this.PageWidth.Formula);
            yield return foo(ShapeSheet.SRCConstants.ShdwObliqueAngle, this.ShdwObliqueAngle.Formula);
            yield return foo(ShapeSheet.SRCConstants.ShdwOffsetX, this.ShdwOffsetX.Formula);
            yield return foo(ShapeSheet.SRCConstants.ShdwOffsetY, this.ShdwOffsetY.Formula);
            yield return foo(ShapeSheet.SRCConstants.ShdwScaleFactor, this.ShdwScaleFactor.Formula);
            yield return foo(ShapeSheet.SRCConstants.ShdwType, this.ShdwType.Formula);
            yield return foo(ShapeSheet.SRCConstants.UIVisibility, this.UIVisibility.Formula);
            yield return foo(ShapeSheet.SRCConstants.XGridDensity, this.XGridDensity.Formula);
            yield return foo(ShapeSheet.SRCConstants.XGridOrigin, this.XGridOrigin.Formula);
            yield return foo(ShapeSheet.SRCConstants.XGridSpacing, this.XGridSpacing.Formula);
            yield return foo(ShapeSheet.SRCConstants.XRulerDensity, this.XRulerDensity.Formula);
            yield return foo(ShapeSheet.SRCConstants.XRulerOrigin, this.XRulerOrigin.Formula);
            yield return foo(ShapeSheet.SRCConstants.YGridDensity, this.YGridDensity.Formula);
            yield return foo(ShapeSheet.SRCConstants.YGridOrigin, this.YGridOrigin.Formula);
            yield return foo(ShapeSheet.SRCConstants.YGridSpacing, this.YGridSpacing.Formula);
            yield return foo(ShapeSheet.SRCConstants.YRulerDensity, this.YRulerDensity.Formula);
            yield return foo(ShapeSheet.SRCConstants.YRulerOrigin, this.YRulerOrigin.Formula);
            yield return foo(ShapeSheet.SRCConstants.AvenueSizeX, this.AvenueSizeX.Formula);
            yield return foo(ShapeSheet.SRCConstants.AvenueSizeY, this.AvenueSizeY.Formula);
            yield return foo(ShapeSheet.SRCConstants.BlockSizeX, this.BlockSizeX.Formula);
            yield return foo(ShapeSheet.SRCConstants.BlockSizeY, this.BlockSizeY.Formula);
            yield return foo(ShapeSheet.SRCConstants.CtrlAsInput, this.CtrlAsInput.Formula);
            yield return foo(ShapeSheet.SRCConstants.DynamicsOff, this.DynamicsOff.Formula);
            yield return foo(ShapeSheet.SRCConstants.EnableGrid, this.EnableGrid.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineAdjustFrom, this.LineAdjustFrom.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineAdjustTo, this.LineAdjustTo.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineJumpCode, this.LineJumpCode.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineJumpFactorX, this.LineJumpFactorX.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineJumpFactorY, this.LineJumpFactorY.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineJumpStyle, this.LineJumpStyle.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineRouteExt, this.LineRouteExt.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineToLineX, this.LineToLineX.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineToLineY, this.LineToLineY.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineToNodeX, this.LineToNodeX.Formula);
            yield return foo(ShapeSheet.SRCConstants.LineToNodeY, this.LineToNodeY.Formula);
            yield return foo(ShapeSheet.SRCConstants.PageLineJumpDirX, this.PageLineJumpDirX.Formula);
            yield return foo(ShapeSheet.SRCConstants.PageLineJumpDirY, this.PageLineJumpDirY.Formula);
            yield return foo(ShapeSheet.SRCConstants.PageShapeSplit, this.PageShapeSplit.Formula);
            yield return foo(ShapeSheet.SRCConstants.PlaceDepth, this.PlaceDepth.Formula);
            yield return foo(ShapeSheet.SRCConstants.PlaceFlip, this.PlaceFlip.Formula);
            yield return foo(ShapeSheet.SRCConstants.PlaceStyle, this.PlaceStyle.Formula);
            yield return foo(ShapeSheet.SRCConstants.PlowCode, this.PlowCode.Formula);
            yield return foo(ShapeSheet.SRCConstants.ResizePage, this.ResizePage.Formula);
            yield return foo(ShapeSheet.SRCConstants.RouteStyle, this.RouteStyle.Formula);
            yield return foo(ShapeSheet.SRCConstants.AvoidPageBreaks, this.AvoidPageBreaks.Formula);
            yield return foo(ShapeSheet.SRCConstants.DrawingResizeType, this.DrawingResizeType.Formula);
        }
