...
{
    public class TextBlockCells : ShapeSheetQuery.CellGroups.CellGroup
    {
        ...
        public static IList<TextBlockCells> GetCells(IVisio.Page page, IList<int> shapeids)
        {
            ...
            return ShapeSheetQuery.CellGroups.CellGroup._GetCells<TextBlockCells, double>(page, shapeids, query, query.GetCells);
        }

        public static TextBlockCells GetCells(IVisio.Shape shape)
        {
            var query = TextBlockCells.lazy_query.Value;
            return ShapeSheetQuery.CellGroups.CellGroup._GetCells<TextBlockCells, double>(shape, query, query.GetCells);
        }
