...
{
    public class Connector : DroppedShape
    {
        public Shape From { get; private set; }
        public Shape To { get; private set; }
        
        public Connector(Shape from, Shape to, IVisio.Master master) :
            base(master,-3,-3)
        {
        ...
        public Connector(Shape from, Shape to, string mastername, string stencilname) :
