...
namespace VisioAutomation.Shapes.Geometry
{
    public class GeometryRow
    {
        ...
        public void AddTo(IVisio.Shape shape, ShapeSheet.Writers.ShapeSheetWriterSrc writer, short row, short section)
        {
        ...
        private void Update(short section_index, short row_index, ShapeSheet.Writers.ShapeSheetWriterSrc writer)
        {
