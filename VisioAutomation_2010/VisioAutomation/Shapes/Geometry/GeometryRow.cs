...
namespace VisioAutomation.Shapes.Geometry
{
    public class GeometryRow
    {
        ...
        public void AddTo(IVisio.Shape shape, FormulaWriter writer, short row, short section)
        {
        ...
        private void Update(short section_index, short row_index, FormulaWriter writer)
        {
