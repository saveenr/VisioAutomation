...
namespace VisioAutomation.Shapes
{
    public class ControlCells : CellGroup
    {
        ...
        public static List<List<ControlCells>> GetCells(IVisio.Page page, IList<int> shapeids, VASS.CellValueType type)
        {
        ...
        class ControlCellsBuilder : CellGroupBuilder<ControlCells>
        {
            ...
            public override ControlCells ToCellGroup(ShapeSheet.Query.ShapeCellsRow<string> row, VisioAutomation.ShapeSheet.Query.ColumnList cols)
            {
