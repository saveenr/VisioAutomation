    ...
    public static class ConnectorHelper
    {
            ...
            bool manual_connection)
        {
            ...
            if (manual_connection)
            {
                ...
                var src_beginx = Core.SrcConstants.OneDBeginX;
                var src_endx = Core.SrcConstants.OneDEndX;
        ...
        public static List<IVisio.Shape> ConnectShapes(IVisio.Page page, IList<IVisio.Shape> fromshapes,
            IList<IVisio.Shape> toshapes,
        ...
        public static List<IVisio.Shape> ConnectShapes(IVisio.Page page, IList<IVisio.Shape> fromshapes,
            IList<IVisio.Shape> toshapes, IVisio.Master connector_master, bool force_manual)
        {
