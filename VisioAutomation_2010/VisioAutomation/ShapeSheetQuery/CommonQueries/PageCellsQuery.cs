...
namespace VisioAutomation.ShapeSheetQuery.CommonQueries
{
    class PageCellsQuery : Query
    {
        ...
        public ColumnSRC CenterY { get; set; }
        public ColumnSRC OnPage { get; set; }
        public ColumnSRC PageBottomMargin { get; set; }
        public ColumnSRC PageRightMargin { get; set; }
        public ColumnSRC PagesX { get; set; }
        public ColumnSRC PagesY { get; set; }
        public ColumnSRC PageTopMargin { get; set; }
        public ColumnSRC PaperKind { get; set; }
        public ColumnSRC PrintGrid { get; set; }
        public ColumnSRC PrintPageOrientation { get; set; }
        public ColumnSRC ScaleX { get; set; }
        public ColumnSRC ScaleY { get; set; }
        public ColumnSRC PaperSource { get; set; }
        public ColumnSRC DrawingScale { get; set; }
        public ColumnSRC DrawingScaleType { get; set; }
        public ColumnSRC DrawingSizeType { get; set; }
        public ColumnSRC InhibitSnap { get; set; }
        public ColumnSRC PageHeight { get; set; }
        public ColumnSRC PageScale { get; set; }
        public ColumnSRC PageWidth { get; set; }
        public ColumnSRC ShdwObliqueAngle { get; set; }
        public ColumnSRC ShdwOffsetX { get; set; }
        public ColumnSRC ShdwOffsetY { get; set; }
        public ColumnSRC ShdwScaleFactor { get; set; }
        public ColumnSRC ShdwType { get; set; }
        public ColumnSRC UIVisibility { get; set; }
        public ColumnSRC XGridDensity { get; set; }
        public ColumnSRC XGridOrigin { get; set; }
        public ColumnSRC XGridSpacing { get; set; }
        public ColumnSRC XRulerDensity { get; set; }
        public ColumnSRC XRulerOrigin { get; set; }
        public ColumnSRC YGridDensity { get; set; }
        public ColumnSRC YGridOrigin { get; set; }
        public ColumnSRC YGridSpacing { get; set; }
        public ColumnSRC YRulerDensity { get; set; }
        public ColumnSRC YRulerOrigin { get; set; }
        public ColumnSRC AvenueSizeX { get; set; }
        public ColumnSRC AvenueSizeY { get; set; }
        public ColumnSRC BlockSizeX { get; set; }
        public ColumnSRC BlockSizeY { get; set; }
        public ColumnSRC CtrlAsInput { get; set; }
        public ColumnSRC DynamicsOff { get; set; }
        public ColumnSRC EnableGrid { get; set; }
        public ColumnSRC LineAdjustFrom { get; set; }
        public ColumnSRC LineAdjustTo { get; set; }
        public ColumnSRC LineJumpCode { get; set; }
        public ColumnSRC LineJumpFactorX { get; set; }
        public ColumnSRC LineJumpFactorY { get; set; }
        public ColumnSRC LineJumpStyle { get; set; }
        public ColumnSRC LineRouteExt { get; set; }
        public ColumnSRC LineToLineX { get; set; }
        public ColumnSRC LineToLineY { get; set; }
        public ColumnSRC LineToNodeX { get; set; }
        public ColumnSRC LineToNodeY { get; set; }
        public ColumnSRC PageLineJumpDirX { get; set; }
        public ColumnSRC PageLineJumpDirY { get; set; }
        public ColumnSRC PageShapeSplit { get; set; }
        public ColumnSRC PlaceDepth { get; set; }
        public ColumnSRC PlaceFlip { get; set; }
        public ColumnSRC PlaceStyle { get; set; }
        public ColumnSRC PlowCode { get; set; }
        public ColumnSRC ResizePage { get; set; }
        public ColumnSRC RouteStyle { get; set; }
        public ColumnSRC AvoidPageBreaks { get; set; }
        public ColumnSRC DrawingResizeType { get; set; }
