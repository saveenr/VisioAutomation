...
namespace VisioAutomation_Tests.DocumentAnalysis
{
    ...
    public class PathAnalysis_Tests : VisioAutomationTest
    {
        ...
        public void Connects_GetDirectedEdges_EdgesWithoutArrowsAreBidirectional()
        {
            ...
            var edges1 = VisioAutomation.DocumentAnalysis.ConnectionAnalyzer.GetDirectedEdges(page1, VisioAutomation.DocumentAnalysis.ConnectorEdgeHandling.NoArrows_Bidirectional);
            ...
            var edges2 = VisioAutomation.DocumentAnalysis.ConnectionAnalyzer.GetTransitiveClosure(page1, VisioAutomation.DocumentAnalysis.ConnectorEdgeHandling.NoArrows_Bidirectional);
        ...
        public void Connects_GetDirectedEdges_EdgesWithoutArrowsAreExcluded()
        {
            ...
            var edges1 = VisioAutomation.DocumentAnalysis.ConnectionAnalyzer.GetDirectedEdges(page1, VisioAutomation.DocumentAnalysis.ConnectorEdgeHandling.NoArrows_Exclude);
            var map1 = new ConnectivityMap(edges1);
            Assert.AreEqual(0, map1.CountFromNodes());

            var edges2 = VisioAutomation.DocumentAnalysis.ConnectionAnalyzer.GetTransitiveClosure(page1, VisioAutomation.DocumentAnalysis.ConnectorEdgeHandling.NoArrows_Exclude);
            var map2 = new ConnectivityMap(edges2);
