...
namespace VisioAutomation_Tests.DocumentAnalysis
{
    ...
    public class PathAnalysis_Tests : VisioAutomationTest
    {
        ...
        public void PathAnalysis_GetDirectEdgesRaw()
        {
            ...
            var edges = VisioAutomation.DocumentAnalysis.ConnectionAnalyzer.GetDirectedEdges(page1, VisioAutomation.DocumentAnalysis.ConnectorEdgeHandling.Raw);
        ...
        public void Connects_GetDirectedEdges_EdgesWithoutArrowsAreBidirectional()
        {
            ...
            var edges1 = VisioAutomation.DocumentAnalysis.ConnectionAnalyzer.GetDirectedEdges(page1, VisioAutomation.DocumentAnalysis.ConnectorEdgeHandling.Arrow_TreatConnectorsWithoutArrowsAsBidirectional);
            ...
            var edges2 = VisioAutomation.DocumentAnalysis.ConnectionAnalyzer.GetTransitiveClosure(page1, VisioAutomation.DocumentAnalysis.ConnectorEdgeHandling.Arrow_TreatConnectorsWithoutArrowsAsBidirectional);
        ...
        public void Connects_GetDirectedEdges_EdgesWithoutArrowsAreExcluded()
        {
            ...
            var edges1 = VisioAutomation.DocumentAnalysis.ConnectionAnalyzer.GetDirectedEdges(page1, VisioAutomation.DocumentAnalysis.ConnectorEdgeHandling.Arrow_ExcludeConnectorsWithoutArrows);
            var map1 = new ConnectivityMap(edges1);
            Assert.AreEqual(0, map1.CountFromNodes());

            var edges2 = VisioAutomation.DocumentAnalysis.ConnectionAnalyzer.GetTransitiveClosure(page1, VisioAutomation.DocumentAnalysis.ConnectorEdgeHandling.Arrow_ExcludeConnectorsWithoutArrows);
            var map2 = new ConnectivityMap(edges2);
