...
namespace VisioAutomation_Tests.Core.Connections
{
    ...
    public class ConnectionPoint_Tests : VisioAutomationTest
    {
        ...
        public void ConnectionPoints_AddRemove()
        {
            ...
            var controlpoints_f = VisioAutomation.Shapes.ConnectionPointHelper.GetConnectionPointCells(s1, CellValueType.Formula);
            var controlpoints_r = VisioAutomation.Shapes.ConnectionPointHelper.GetConnectionPointCells(s1,CellValueType.Result);
