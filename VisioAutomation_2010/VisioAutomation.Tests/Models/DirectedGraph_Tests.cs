...
namespace VisioAutomation_Tests.Models
{
    ...
    public class DirectedGraph_Tests : VisioAutomationTest
    {
        ...
        public void RenderDirectedGraphWithCustomProps()
        {
            ...
            n0.CustomProperties["p1"] = CustomPropertyHelper.FromValue("v1");
            n0.CustomProperties["p2"] = CustomPropertyHelper.FromValue("v2");
            n0.CustomProperties["p3"] = CustomPropertyHelper.FromValue("v3");
            ...
            var props_dic = CustomPropertyHelper.GetValues(n0.VisioShape, CellValueType.Formula);
