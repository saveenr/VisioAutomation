...
namespace VisioAutomation_Tests.Utilities
{
    ...
    public class ArraySegmentTests
    {
        ...
        public void Basics()
        {
            ...
            try
            {
                var s = new VA.Collections.ArraySegmentReader<int>(null);
            }
        ...
        public void Segment_read_full_array_exactly()
        {
            ...
            var s = new VA.Collections.ArraySegmentReader<int>(a);
        ...
        private static void CheckOverflow(VA.Collections.ArraySegmentReader<int> s, int size)
        {
            bool caught = false;
            try
            {
