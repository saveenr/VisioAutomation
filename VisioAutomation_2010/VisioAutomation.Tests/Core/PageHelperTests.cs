...
namespace VisioAutomation_Tests.Core.Page
{
    ...
    public class PageHelperTests : VisioAutomationTest
    {
        ...
        public void Page_Query()
        {
            ...
            var page_fmt_cells = VA.Pages.PageHelper.GetPageFormatCells(page1.PageSheet, CellValueType.Formula);
            ...
            var actual_page_format_cells = VA.Pages.PageHelper.GetPageFormatCells(page1.PageSheet, CellValueType.Result);
            ...
            double expected_piny)
        {
            ...
            var xform = VA.Shapes.ShapeHelper.GetShapeXFormCells(shape, CellValueType.Result);
