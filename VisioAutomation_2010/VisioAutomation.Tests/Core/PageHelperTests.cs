...
namespace VisioAutomation_Tests.Core.Page
{
    ...
    public class PageHelperTests : VisioAutomationTest
    {
        ...
        public void Page_Query()
        {
            ...
            var page_fmt_cells = VA.Pages.PageFormatCells.GetFormulas(page1.PageSheet);
            ...
            var actual_page_format_cells = VA.Pages.PageFormatCells.GetResults(page1.PageSheet);
            ...
            double expected_piny)
        {
            ...
            var xform = VA.Shapes.ShapeXFormCells.GetResults(shape);
