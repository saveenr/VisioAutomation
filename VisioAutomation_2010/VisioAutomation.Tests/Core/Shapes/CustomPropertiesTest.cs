...
namespace VisioAutomation_Tests.Core.Shapes
{
    ...
    public class CustomPropertiesTest : VisioAutomationTest
    {
        ...
        public void SimpleCP()
        {
            ...
            var props = CustomPropertyHelper.Get(s1, CellValueType.Formula);
        ...
        public void CustomProps_CRUD()
        {
            ...
            var c0 = CustomPropertyHelper.Get(s1, CellValueType.Formula);
            ...
            var c1 = CustomPropertyHelper.Get(s1, CellValueType.Formula);
            ...
            var c2 = CustomPropertyHelper.Get(s1, CellValueType.Formula);
            ...
            var c3 = CustomPropertyHelper.Get(s1, CellValueType.Formula);
            ...
            var c4 = CustomPropertyHelper.Get(s1, CellValueType.Formula);
        ...
        public void CustomProps_AllTypes()
        {
            ...
            var props_dic = CustomPropertyHelper.Get(s1, CellValueType.Formula);
