...
namespace VisioAutomation_Tests.Core.Shapes
{
    ...
    public class CustomPropertiesTest : VisioAutomationTest
    {
        ...
        public void CustomProps_CRUD()
        {
            ...
            var c0 = CustomPropertyHelper.GetDictionary(s1, CellValueType.Formula);
            ...
            var c1 = CustomPropertyHelper.GetDictionary(s1, CellValueType.Formula);
            ...
            var c2 = CustomPropertyHelper.GetDictionary(s1, CellValueType.Formula);
            ...
            var c3 = CustomPropertyHelper.GetDictionary(s1, CellValueType.Formula);
            ...
            var c4 = CustomPropertyHelper.GetDictionary(s1, CellValueType.Formula);
