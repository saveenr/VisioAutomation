...
namespace VisioAutomation_Tests.Core.ShapeSheet
{
    ...
    public class ShapeSheetQueryTests : VisioAutomationTest
    {
        ...
        public void ShapeSheet_Query_Demo_AllCellsAndSections()
        {
            ...
            var section_to_secquery = new Dictionary<short,VA.ShapeSheetQuery.SectionColumn>();
            ...
            foreach (var kv in name_to_src)
            {
                ...
                {
                    VA.ShapeSheetQuery.SectionColumn sec_col;
        ...
        public void ShapeSheet_Query_TestDuplicates()
        {
            ...
            var q1 = new VA.ShapeSheetQuery.CellQuery();
            ...
            var q2 = new VA.ShapeSheetQuery.CellQuery();
            ...
            var q3 = new VA.ShapeSheetQuery.CellQuery();
