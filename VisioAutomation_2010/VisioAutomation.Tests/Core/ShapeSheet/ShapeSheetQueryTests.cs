...
namespace VisioAutomation_Tests.Core.ShapeSheet
{
    ...
    public class ShapeSheetQueryTests : VisioAutomationTest
    {
        ...
        public void ShapeSheet_Query_SectionRowHandling()
        {
            ...
            Assert.AreEqual("\"1\"", data[0].Sections[prop_sec].Rows[0].Cells[0].ValueF);
            Assert.AreEqual("\"2\"", data[1].Sections[prop_sec].Rows[0].Cells[0].ValueF);
            Assert.AreEqual("\"3\"", data[1].Sections[prop_sec].Rows[1].Cells[0].ValueF);
            Assert.AreEqual("\"4\"", data[3].Sections[prop_sec].Rows[0].Cells[0].ValueF);
            Assert.AreEqual("\"5\"", data[3].Sections[prop_sec].Rows[1].Cells[0].ValueF);
            Assert.AreEqual("\"6\"", data[3].Sections[prop_sec].Rows[2].Cells[0].ValueF);


            Assert.AreEqual( "1", data[0].Sections[prop_sec].Rows[0].Cells[0].ValueR);
            Assert.AreEqual( "2", data[1].Sections[prop_sec].Rows[0].Cells[0].ValueR);
            Assert.AreEqual( "3", data[1].Sections[prop_sec].Rows[1].Cells[0].ValueR);
            Assert.AreEqual( "4", data[3].Sections[prop_sec].Rows[0].Cells[0].ValueR);
            Assert.AreEqual( "5", data[3].Sections[prop_sec].Rows[1].Cells[0].ValueR);
            Assert.AreEqual( "6", data[3].Sections[prop_sec].Rows[2].Cells[0].ValueR);
        ...
        public void ShapeSheet_Query_Demo_AllCellsAndSections()
        {
            ...
            var results2 = query.GetResults<double>(page1, new[] { s1.ID, s2.ID });
