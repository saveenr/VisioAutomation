...
namespace VisioAutomation_Tests.Core.ShapeSheet
{
    ...
    public class ShapeSheetQueryTests : VisioAutomationTest
    {
        ...
        public void ShapeSheet_Query_SectionRowHandling()
        {
            ...
            AssertUtil.AreEqual("\"1\"", "1", data[0].Sections[prop_sec].Rows[0].Cells[0]);
            AssertUtil.AreEqual("\"2\"", "2", data[1].Sections[prop_sec].Rows[0].Cells[0]);
            AssertUtil.AreEqual("\"3\"", "3", data[1].Sections[prop_sec].Rows[1].Cells[0]);
            AssertUtil.AreEqual("\"4\"", "4", data[3].Sections[prop_sec].Rows[0].Cells[0]);
            AssertUtil.AreEqual("\"5\"", "5", data[3].Sections[prop_sec].Rows[1].Cells[0]);
            AssertUtil.AreEqual("\"6\"", "6", data[3].Sections[prop_sec].Rows[2].Cells[0]);
