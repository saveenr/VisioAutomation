...
namespace VisioAutomation_Tests
{
    ...
    public class VisioAutomationTest
    {
        ...
        public static VisioAutomation.Geometry.Size GetSize(IVisio.Shape shape)
        {
            ...
            var col_w = query.AddColumn(VisioAutomation.ShapeSheet.SrcConstants.XFormWidth,"Width");
            var col_h = query.AddColumn(VisioAutomation.ShapeSheet.SrcConstants.XFormHeight,"Height");
        ...
        public static VisioAutomation.Geometry.Size GetPageSize(IVisio.Page page)
        {
            ...
            var query = new CellQuery();
            var col_height = query.AddColumn(VisioAutomation.ShapeSheet.SrcConstants.PageHeight, "PageHeight");
            var col_width = query.AddColumn(VisioAutomation.ShapeSheet.SrcConstants.PageWidth, "PageWidth");
