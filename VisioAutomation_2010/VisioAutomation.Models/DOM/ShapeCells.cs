...
namespace VisioAutomation.Models.Dom
{
    ...
    {
        // XFormOut
        public ShapeSheet.ValueLiteral Width { get; set; }
        public ShapeSheet.ValueLiteral Height { get; set; }
        public ShapeSheet.ValueLiteral Angle { get; set; }
        public ShapeSheet.ValueLiteral PinX { get; set; }
        public ShapeSheet.ValueLiteral PinY { get; set; }
        public ShapeSheet.ValueLiteral LocPinX { get; set; }
        public ShapeSheet.ValueLiteral LocPinY { get; set; }

        // Fill
        public ShapeSheet.ValueLiteral FillBkgnd { get; set; }
        public ShapeSheet.ValueLiteral FillBkgndTrans { get; set; }
        public ShapeSheet.ValueLiteral FillForegnd { get; set; }
        public ShapeSheet.ValueLiteral FillForegndTrans { get; set; }
        public ShapeSheet.ValueLiteral FillPattern { get; set; }
        public ShapeSheet.ValueLiteral ShapeShdwObliqueAngle { get; set; }
        public ShapeSheet.ValueLiteral ShapeShdwOffsetX { get; set; }
        public ShapeSheet.ValueLiteral ShapeShdwOffsetY { get; set; }
        public ShapeSheet.ValueLiteral ShapeShdwScaleFactor { get; set; }
        public ShapeSheet.ValueLiteral ShapeShdwType { get; set; }
        public ShapeSheet.ValueLiteral ShdwBkgnd { get; set; }
        public ShapeSheet.ValueLiteral ShdwBkgndTrans { get; set; }
        public ShapeSheet.ValueLiteral ShdwForegnd { get; set; }
        public ShapeSheet.ValueLiteral ShdwForegndTrans { get; set; }
        public ShapeSheet.ValueLiteral ShdwPattern { get; set; }

        // Line
        public ShapeSheet.ValueLiteral BeginArrow { get; set; }
        public ShapeSheet.ValueLiteral BeginArrowSize { get; set; }
        public ShapeSheet.ValueLiteral EndArrow { get; set; }
        public ShapeSheet.ValueLiteral EndArrowSize { get; set; }
        public ShapeSheet.ValueLiteral LineCap { get; set; }
        public ShapeSheet.ValueLiteral LineColor { get; set; }
        public ShapeSheet.ValueLiteral LineColorTrans { get; set; }
        public ShapeSheet.ValueLiteral LinePattern { get; set; }
        public ShapeSheet.ValueLiteral LineWeight { get; set; }
        public ShapeSheet.ValueLiteral Rounding { get; set; }

        // Character
        public ShapeSheet.ValueLiteral CharAsianFont { get; set; }
        public ShapeSheet.ValueLiteral CharCase { get; set; }
        public ShapeSheet.ValueLiteral CharColor { get; set; }
        public ShapeSheet.ValueLiteral CharComplexScriptFont { get; set; }
        public ShapeSheet.ValueLiteral CharComplexScriptSize { get; set; }
        public ShapeSheet.ValueLiteral CharDoubleStrikeThrough { get; set; }
        public ShapeSheet.ValueLiteral CharDoubleUnderline { get; set; }
        public ShapeSheet.ValueLiteral CharFont { get; set; }
        public ShapeSheet.ValueLiteral CharFontScale { get; set; }
        public ShapeSheet.ValueLiteral CharLangID { get; set; }
        public ShapeSheet.ValueLiteral CharLetterspace { get; set; }
        public ShapeSheet.ValueLiteral CharLocale { get; set; }
        public ShapeSheet.ValueLiteral CharLocalizeFont { get; set; }
        public ShapeSheet.ValueLiteral CharOverline { get; set; }
        public ShapeSheet.ValueLiteral CharPerpendicular { get; set; }
        public ShapeSheet.ValueLiteral CharPos { get; set; }
        public ShapeSheet.ValueLiteral CharRTLText { get; set; }
        public ShapeSheet.ValueLiteral CharSize { get; set; }
        public ShapeSheet.ValueLiteral CharStrikethru { get; set; }
        public ShapeSheet.ValueLiteral CharStyle { get; set; }
        public ShapeSheet.ValueLiteral CharTransparency { get; set; }
        public ShapeSheet.ValueLiteral CharUseVertical { get; set; }

        // Text Block
        public ShapeSheet.ValueLiteral BottomMargin { get; set; }
        public ShapeSheet.ValueLiteral DefaultTabstop { get; set; }
        public ShapeSheet.ValueLiteral LeftMargin { get; set; }
        public ShapeSheet.ValueLiteral RightMargin { get; set; }
        public ShapeSheet.ValueLiteral TextBkgnd { get; set; }
        public ShapeSheet.ValueLiteral TextBkgndTrans { get; set; }
        public ShapeSheet.ValueLiteral TextDirection { get; set; }
        public ShapeSheet.ValueLiteral TopMargin { get; set; }
        public ShapeSheet.ValueLiteral VerticalAlign { get; set; }

        // Paragraph
        public ShapeSheet.ValueLiteral ParaBullet { get; set; }
        public ShapeSheet.ValueLiteral ParaBulletFont { get; set; }
        public ShapeSheet.ValueLiteral ParaBulletFontSize { get; set; }
        public ShapeSheet.ValueLiteral ParaBulletString { get; set; }
        public ShapeSheet.ValueLiteral ParaFlags { get; set; }
        public ShapeSheet.ValueLiteral ParaHorizontalAlign { get; set; }
        public ShapeSheet.ValueLiteral ParaIndentFirst { get; set; }
        public ShapeSheet.ValueLiteral ParaIndentLeft { get; set; }
        public ShapeSheet.ValueLiteral ParaIndentRight { get; set; }
        public ShapeSheet.ValueLiteral ParaLocBulletFont { get; set; }
        public ShapeSheet.ValueLiteral ParaSpacingAfter { get; set; }
        public ShapeSheet.ValueLiteral ParaSpacingBefore { get; set; }
        public ShapeSheet.ValueLiteral ParaSpacingLine { get; set; }
        public ShapeSheet.ValueLiteral ParaTextPosAfterBullet { get; set; }

        //TextXForm
        public ShapeSheet.ValueLiteral TxtAngle { get; set; }
        public ShapeSheet.ValueLiteral TxtHeight { get; set; }
        public ShapeSheet.ValueLiteral TxtLocPinX { get; set; }
        public ShapeSheet.ValueLiteral TxtLocPinY { get; set; }
        public ShapeSheet.ValueLiteral TxtPinX { get; set; }
        public ShapeSheet.ValueLiteral TxtPinY { get; set; }
        public ShapeSheet.ValueLiteral TxtWidth { get; set; }

        // ShapeLayout
        public ShapeSheet.ValueLiteral ConFixedCode { get; set; }
        public ShapeSheet.ValueLiteral ConLineJumpCode { get; set; }
        public ShapeSheet.ValueLiteral ConLineJumpDirX { get; set; }
        public ShapeSheet.ValueLiteral ConLineJumpDirY { get; set; }
        public ShapeSheet.ValueLiteral ConLineJumpStyle { get; set; }
        public ShapeSheet.ValueLiteral ConLineRouteExt { get; set; }
        public ShapeSheet.ValueLiteral ShapeFixedCode { get; set; }
        public ShapeSheet.ValueLiteral ShapePermeablePlace { get; set; }
        public ShapeSheet.ValueLiteral ShapePermeableX { get; set; }
        public ShapeSheet.ValueLiteral ShapePermeableY { get; set; }
        public ShapeSheet.ValueLiteral ShapePlaceFlip { get; set; }
        public ShapeSheet.ValueLiteral ShapePlaceStyle { get; set; }
        public ShapeSheet.ValueLiteral ShapePlowCode { get; set; }
        public ShapeSheet.ValueLiteral ShapeRouteStyle { get; set; }
        public ShapeSheet.ValueLiteral ShapeSplit { get; set; }
        ...
        {
            if (this.Width.HasValue) { target.Width = this.Width; }
            if (this.Height.HasValue) { target.Height = this.Height; }
            if (this.Angle.HasValue) { target.Angle = this.Angle; }
            if (this.PinX.HasValue) { target.PinX = this.PinX; }
            if (this.PinY.HasValue) { target.PinY = this.PinY; }
            if (this.LocPinX.HasValue) { target.LocPinX = this.LocPinX; }
            if (this.LocPinY.HasValue) { target.LocPinY = this.LocPinY; }
            if (this.FillBkgnd.HasValue) { target.FillBkgnd = this.FillBkgnd; }
            if (this.FillBkgndTrans.HasValue) { target.FillBkgndTrans = this.FillBkgndTrans; }
            if (this.FillForegnd.HasValue) { target.FillForegnd = this.FillForegnd; }
            if (this.FillForegndTrans.HasValue) { target.FillForegndTrans = this.FillForegndTrans; }
            if (this.FillPattern.HasValue) { target.FillPattern = this.FillPattern; }
            if (this.ShapeShdwObliqueAngle.HasValue) { target.ShapeShdwObliqueAngle = this.ShapeShdwObliqueAngle; }
            if (this.ShapeShdwOffsetX.HasValue) { target.ShapeShdwOffsetX = this.ShapeShdwOffsetX; }
            if (this.ShapeShdwOffsetY.HasValue) { target.ShapeShdwOffsetY = this.ShapeShdwOffsetY; }
            if (this.ShapeShdwScaleFactor.HasValue) { target.ShapeShdwScaleFactor = this.ShapeShdwScaleFactor; }
            if (this.ShapeShdwType.HasValue) { target.ShapeShdwType = this.ShapeShdwType; }
            if (this.ShdwBkgnd.HasValue) { target.ShdwBkgnd = this.ShdwBkgnd; }
            if (this.ShdwBkgndTrans.HasValue) { target.ShdwBkgndTrans = this.ShdwBkgndTrans; }
            if (this.ShdwForegnd.HasValue) { target.ShdwForegnd = this.ShdwForegnd; }
            if (this.ShdwForegndTrans.HasValue) { target.ShdwForegndTrans = this.ShdwForegndTrans; }
            if (this.ShdwPattern.HasValue) { target.ShdwPattern = this.ShdwPattern; }
            if (this.BeginArrow.HasValue) { target.BeginArrow = this.BeginArrow; }
            if (this.BeginArrowSize.HasValue) { target.BeginArrowSize = this.BeginArrowSize; }
            if (this.EndArrow.HasValue) { target.EndArrow = this.EndArrow; }
            if (this.EndArrowSize.HasValue) { target.EndArrowSize = this.EndArrowSize; }
            if (this.LineCap.HasValue) { target.LineCap = this.LineCap; }
            if (this.LineColor.HasValue) { target.LineColor = this.LineColor; }
            if (this.LineColorTrans.HasValue) { target.LineColorTrans = this.LineColorTrans; }
            ...
            if (this.BottomMargin.HasValue) { target.BottomMargin = this.BottomMargin; }
            if (this.DefaultTabstop.HasValue) { target.DefaultTabstop = this.DefaultTabstop; }
            if (this.LeftMargin.HasValue) { target.LeftMargin = this.LeftMargin; }
            if (this.RightMargin.HasValue) { target.RightMargin = this.RightMargin; }
            if (this.TextBkgnd.HasValue) { target.TextBkgnd = this.TextBkgnd; }
            if (this.TextBkgndTrans.HasValue) { target.TextBkgndTrans = this.TextBkgndTrans; }
            if (this.TextDirection.HasValue) { target.TextDirection = this.TextDirection; }
            if (this.TopMargin.HasValue) { target.TopMargin = this.TopMargin; }
            if (this.VerticalAlign.HasValue) { target.VerticalAlign = this.VerticalAlign; }
            ...
            if (this.TxtAngle.HasValue) { target.TxtAngle = this.TxtAngle; }
            if (this.TxtHeight.HasValue) { target.TxtHeight = this.TxtHeight; }
            if (this.TxtLocPinX.HasValue) { target.TxtLocPinX = this.TxtLocPinX; }
            if (this.TxtLocPinY.HasValue) { target.TxtLocPinY = this.TxtLocPinY; }
            if (this.TxtPinX.HasValue) { target.TxtPinX = this.TxtPinX; }
            if (this.TxtPinY.HasValue) { target.TxtPinY = this.TxtPinY; }
            if (this.TxtWidth.HasValue) { target.TxtWidth = this.TxtWidth; }
            if (this.ConFixedCode.HasValue) { target.ConFixedCode = this.ConFixedCode; }
            if (this.ConLineJumpCode.HasValue) { target.ConLineJumpCode = this.ConLineJumpCode; }
            if (this.ConLineJumpDirX.HasValue) { target.ConLineJumpDirX = this.ConLineJumpDirX; }
            if (this.ConLineJumpDirY.HasValue) { target.ConLineJumpDirY = this.ConLineJumpDirY; }
            if (this.ConLineJumpStyle.HasValue) { target.ConLineJumpStyle = this.ConLineJumpStyle; }
            if (this.ConLineRouteExt.HasValue) { target.ConLineRouteExt = this.ConLineRouteExt; }
            if (this.ShapeFixedCode.HasValue) { target.ShapeFixedCode = this.ShapeFixedCode; }
            if (this.ShapePermeablePlace.HasValue) { target.ShapePermeablePlace = this.ShapePermeablePlace; }
            if (this.ShapePermeableX.HasValue) { target.ShapePermeableX = this.ShapePermeableX; }
            if (this.ShapePermeableY.HasValue) { target.ShapePermeableY = this.ShapePermeableY; }
            if (this.ShapePlaceFlip.HasValue) { target.ShapePlaceFlip = this.ShapePlaceFlip; }
            if (this.ShapePlaceStyle.HasValue) { target.ShapePlaceStyle = this.ShapePlaceStyle; }
            if (this.ShapePlowCode.HasValue) { target.ShapePlowCode = this.ShapePlowCode; }
            if (this.ShapeRouteStyle.HasValue) { target.ShapeRouteStyle = this.ShapeRouteStyle; }
            if (this.ShapeSplit.HasValue) { target.ShapeSplit = this.ShapeSplit; }
            if (this.ShapeSplittable.HasValue) { target.ShapeSplittable = this.ShapeSplittable; }
        }
    }
}