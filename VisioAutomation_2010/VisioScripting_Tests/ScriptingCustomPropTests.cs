...
namespace VisioAutomation_Tests.Scripting
{
    ...
    public class ScriptingCustomPropTests : VisioAutomationTest
    {
        ...
        public void Scripting_CustomProps_Scenarios()
        {
            ...
            var prop_dic0 = client.CustomProperty.GetCustomProperties_ShapeDictionary(targetshapes, VisioAutomation.ShapeSheet.CellValueType.Formula);
            ...
            var prop_dic1 = client.CustomProperty.GetCustomProperties_ShapeDictionary(targetshapes, VisioAutomation.ShapeSheet.CellValueType.Formula);
            ...
            var prop_dic2 = client.CustomProperty.GetCustomProperties_ShapeDictionary(targetshapes, VisioAutomation.ShapeSheet.CellValueType.Formula);
