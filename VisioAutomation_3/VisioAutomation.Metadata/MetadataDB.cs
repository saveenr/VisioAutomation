...
namespace VisioAutomation.Metadata
{
    ...
    public class MetadataDB
    {
        ...
        {
            var cellreader = new XmlPersist.XmlTableReader<Cell>();
            this._cells  = cellreader.LoadFromString(VA.Metadata.Properties.Resources.cells).ToList();
        ...
        {
            var secreader = new XmlPersist.XmlTableReader<Section>();
            this._sections = secreader.LoadFromString(VA.Metadata.Properties.Resources.sections).ToList();
        ...
        {
            var conreader = new XmlPersist.XmlTableReader<AutomationConstant>();
            this._constants = conreader.LoadFromString(VA.Metadata.Properties.Resources.constants).ToList();
        ...
        {
            var cvreader = new XmlPersist.XmlTableReader<CellValue>();
            this._cellvals = cvreader.LoadFromString(VA.Metadata.Properties.Resources.cellvalues).ToList();
        }
