...
{
    [SMA.Cmdlet("Draw", "PieSlices")]
    public class Draw_PieSlices : VisioPS.VisioPSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var shapes = scriptingsession.Draw.DrawPieSlices(center, this.Radius, this.Values);
