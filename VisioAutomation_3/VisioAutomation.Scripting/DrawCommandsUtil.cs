...
namespace VisioAutomation.Scripting
{
    public static class DrawCommandsUtil
    {
        ...
        public static IVisio.Shape DrawOuterGlow(IVisio.Page page,
                                                 ...
                                                 int glow_trans)
        {
            ...
            var rects = GetOuterBorderRects(rect, glow_width);
            ...
            for (int i=0;i<shapes.Length;i++)
            {
                ...
                update.SetFormula((short)shapeid, VA.ShapeSheet.SRCConstants.FillForegnd, VA.Convert.ColorToFormulaRGB(glow_color) );
                update.SetFormula((short)shapeid, VA.ShapeSheet.SRCConstants.FillBkgnd, VA.Convert.ColorToFormulaRGB(bg_color) );
                update.SetFormula((short)shapeid, VA.ShapeSheet.SRCConstants.FillForegndTrans, glow_trans);
