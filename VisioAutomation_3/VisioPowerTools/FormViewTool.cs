...
namespace VisioPowerTools
{
    public partial class FormViewTool 
    {
        ...
        {
            VisioPowerToolsAddIn.ScriptingSession.Page.GoTo(VA.PageNavigation.PreviousPage);
        }
        
        private void buttonNextPage_Click(object sender, System.EventArgs e)
        {
            VisioPowerToolsAddIn.ScriptingSession.Page.GoTo(VA.PageNavigation.NextPage);
        }
        ...
        {
            VisioPowerToolsAddIn.ScriptingSession.Page.GoTo(VA.PageNavigation.FirstPage);
        }

        private void buttonPageLast_Click(object sender, System.EventArgs e)
        {
            VisioPowerToolsAddIn.ScriptingSession.Page.GoTo(VA.PageNavigation.LastPage);
        }
    }
}