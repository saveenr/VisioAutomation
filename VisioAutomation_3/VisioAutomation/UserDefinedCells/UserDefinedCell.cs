...
namespace VisioAutomation.UserDefinedCells
{
    public class UserDefinedCell
    {
        ...
        internal static readonly VA.UserDefinedCells.UserDefinedCellQuery query = new VA.UserDefinedCells.UserDefinedCellQuery();
    ...
    public static class UserDefinedCellsHelper
    {
        ...
        public static void DeleteUserDefinedCell(Shape shape, string name)
        {
            if (shape == null)
            {
        ...
        public static void UpdateUserDefinedCell(Shape shape, string name, string val)
        {
            if (shape == null)
            {
                throw new ArgumentNullException("shape");
        ...
        public static void SetUserDefinedCell(Shape shape, string name, string value, string prompt)
        {
            if (shape == null)
            {
                throw new ArgumentNullException("shape");
        ...
        /// 
        // TODO: Add Unit Test
        public static IList<UserDefinedCell> GetUserDefinedCells(Shape shape)
        {
            if (shape == null)
            {
                throw new ArgumentNullException("shape");
            ...
            var rows = new List<int>(formulas.Rows.Count);
        ...
        public static IList<List<UserDefinedCell>> GetUserDefinedCells(Page page, IList<Shape> shapes)
        {
            if (page == null)
            {
        ...
        /// <param name="shape"></param>
        /// <returns></returns>
        public static int GetUserDefinedCellCount(Shape shape)
        {
            if (shape == null)
            {
                throw new ArgumentNullException("shape");
            ...
            if (0 == shape.SectionExists[UserDefinedCell.query.Section, (short)VisExistsFlags.visExistsAnywhere])
            {
                return 0;
            }
        ...
        /// <param name="shape"></param>
        /// <returns></returns>
        public static IList<string> GetUserDefinedCellNames(Shape shape)
        {
            if (shape == null)
            {
                throw new ArgumentNullException("shape");
