...
namespace VisioAutomation.ShapeSheet.Update
{
    public class SIDSRCUpdate : UpdateBase<SIDSRC>
    {
        ...
        private short SetResults( IVisio.Page page)
        {
            ...
            var stream = VA.ShapeSheet.SIDSRCStream.FromItems(this.ResultData.Items, r => r.StreamItem);
        ...
        private short SetFormulas(IVisio.Page page)
        {
            ...
            var stream = VA.ShapeSheet.SIDSRCStream.FromItems(this.FormulaData.Items, r => r.StreamItem);
