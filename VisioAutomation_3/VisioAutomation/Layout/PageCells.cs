...
namespace VisioAutomation.Layout
{
    public partial class PageCells : VA.ShapeSheet.CellDataGroup
    {
        ...
        private static PageCells get_cells_from_row(PageQuery query, VA.ShapeSheet.Query.QueryDataRow<double> qds)
        {

            var cells = new PageCells();
            cells.PageLeftMargin = qds.GetItem(query.PageLeftMargin);
            cells.CenterX = qds.GetItem(query.CenterX);
            cells.CenterY = qds.GetItem(query.CenterY);
            cells.OnPage = qds.GetItem(query.OnPage).ToInt();
            cells.PageBottomMargin = qds.GetItem(query.PageBottomMargin);
            cells.PageRightMargin = qds.GetItem(query.PageRightMargin);
            cells.PagesX = qds.GetItem(query.PagesX);
            cells.PagesY = qds.GetItem(query.PagesY);
            cells.PageTopMargin = qds.GetItem(query.PageTopMargin);
            cells.PaperKind = qds.GetItem(query.PaperKind).ToInt();
            cells.PrintGrid = qds.GetItem(query.PrintGrid).ToInt();
            cells.PrintPageOrientation = qds.GetItem(query.PrintPageOrientation).ToInt();
            cells.ScaleX = qds.GetItem(query.ScaleX);
            cells.ScaleY = qds.GetItem(query.ScaleY);
            cells.PaperSource = qds.GetItem(query.PaperSource).ToInt();
            cells.DrawingScale = qds.GetItem(query.DrawingScale);
            cells.DrawingScaleType = qds.GetItem(query.DrawingScaleType).ToInt();
            cells.DrawingSizeType = qds.GetItem(query.DrawingSizeType).ToInt();
            cells.InhibitSnap = qds.GetItem(query.InhibitSnap).ToInt();
            cells.PageHeight = qds.GetItem(query.PageHeight);
            cells.PageScale = qds.GetItem(query.PageScale);
            cells.PageWidth = qds.GetItem(query.PageWidth);
            cells.ShdwObliqueAngle = qds.GetItem(query.ShdwObliqueAngle);
            cells.ShdwOffsetX = qds.GetItem(query.ShdwOffsetX);
            cells.ShdwOffsetY = qds.GetItem(query.ShdwOffsetY);
            cells.ShdwScaleFactor = qds.GetItem(query.ShdwScaleFactor);
            cells.ShdwType = qds.GetItem(query.ShdwType).ToInt();
            cells.UIVisibility = qds.GetItem(query.UIVisibility);
            cells.XGridDensity = qds.GetItem(query.XGridDensity);
            cells.XGridOrigin = qds.GetItem(query.XGridOrigin);
            cells.XGridSpacing = qds.GetItem(query.XGridSpacing);
            cells.XRulerDensity = qds.GetItem(query.XRulerDensity);
            cells.XRulerOrigin = qds.GetItem(query.XRulerOrigin);
            cells.YGridDensity = qds.GetItem(query.YGridDensity);
            cells.YGridOrigin = qds.GetItem(query.YGridOrigin);
            cells.YGridSpacing = qds.GetItem(query.YGridSpacing);
            cells.YRulerDensity = qds.GetItem(query.YRulerDensity);
            cells.YRulerOrigin = qds.GetItem(query.YRulerOrigin);
            cells.AvenueSizeX = qds.GetItem(query.AvenueSizeX);
            cells.AvenueSizeY = qds.GetItem(query.AvenueSizeY);
            cells.BlockSizeX = qds.GetItem(query.BlockSizeX);
            cells.BlockSizeY = qds.GetItem(query.BlockSizeY);
            cells.CtrlAsInput = qds.GetItem(query.CtrlAsInput).ToInt();
            cells.DynamicsOff = qds.GetItem(query.DynamicsOff).ToInt();
            cells.EnableGrid = qds.GetItem(query.EnableGrid).ToInt();
            cells.LineAdjustFrom = qds.GetItem(query.LineAdjustFrom).ToInt();
            cells.LineAdjustTo = qds.GetItem(query.LineAdjustTo);
            cells.LineJumpCode = qds.GetItem(query.LineJumpCode);
            cells.LineJumpFactorX = qds.GetItem(query.LineJumpFactorX);
            cells.LineJumpFactorY = qds.GetItem(query.LineJumpFactorY);
            cells.LineJumpStyle = qds.GetItem(query.LineJumpStyle).ToInt();
            cells.LineRouteExt = qds.GetItem(query.LineRouteExt);
            cells.LineToLineX = qds.GetItem(query.LineToLineX);
            cells.LineToLineY = qds.GetItem(query.LineToLineY);
            cells.LineToNodeX = qds.GetItem(query.LineToNodeX);
            cells.LineToNodeY = qds.GetItem(query.LineToNodeY);
            cells.PageLineJumpDirX = qds.GetItem(query.PageLineJumpDirX);
            cells.PageLineJumpDirY = qds.GetItem(query.PageLineJumpDirY);
            cells.PageShapeSplit = qds.GetItem(query.PageShapeSplit).ToInt();
            cells.PlaceDepth = qds.GetItem(query.PlaceDepth).ToInt();
            cells.PlaceFlip = qds.GetItem(query.PlaceFlip).ToInt();
            cells.PlaceStyle = qds.GetItem(query.PlaceStyle).ToInt();
            cells.PlowCode = qds.GetItem(query.PlowCode).ToInt();
            cells.ResizePage = qds.GetItem(query.ResizePage).ToInt();
            cells.RouteStyle = qds.GetItem(query.RouteStyle).ToInt();
            return cells;
        }
