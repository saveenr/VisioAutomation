...
namespace VisioAutomation.Layout
{
    public partial class PageCells : VA.ShapeSheet.CellDataGroup
    {
        ...
        private static PageCells get_cells_from_row(PageQuery query, VA.ShapeSheet.Query.QueryDataRow<double> row)
        {
            ...
            cells.PageLeftMargin = row.GetItem(query.PageLeftMargin);
            cells.CenterX = row.GetItem(query.CenterX);
            cells.CenterY = row.GetItem(query.CenterY);
            cells.OnPage = row.GetItem(query.OnPage).ToInt();
            cells.PageBottomMargin = row.GetItem(query.PageBottomMargin);
            cells.PageRightMargin = row.GetItem(query.PageRightMargin);
            cells.PagesX = row.GetItem(query.PagesX);
            cells.PagesY = row.GetItem(query.PagesY);
            cells.PageTopMargin = row.GetItem(query.PageTopMargin);
            cells.PaperKind = row.GetItem(query.PaperKind).ToInt();
            cells.PrintGrid = row.GetItem(query.PrintGrid).ToInt();
            cells.PrintPageOrientation = row.GetItem(query.PrintPageOrientation).ToInt();
            cells.ScaleX = row.GetItem(query.ScaleX);
            cells.ScaleY = row.GetItem(query.ScaleY);
            cells.PaperSource = row.GetItem(query.PaperSource).ToInt();
            cells.DrawingScale = row.GetItem(query.DrawingScale);
            cells.DrawingScaleType = row.GetItem(query.DrawingScaleType).ToInt();
            cells.DrawingSizeType = row.GetItem(query.DrawingSizeType).ToInt();
            cells.InhibitSnap = row.GetItem(query.InhibitSnap).ToInt();
            cells.PageHeight = row.GetItem(query.PageHeight);
            cells.PageScale = row.GetItem(query.PageScale);
            cells.PageWidth = row.GetItem(query.PageWidth);
            cells.ShdwObliqueAngle = row.GetItem(query.ShdwObliqueAngle);
            cells.ShdwOffsetX = row.GetItem(query.ShdwOffsetX);
            cells.ShdwOffsetY = row.GetItem(query.ShdwOffsetY);
            cells.ShdwScaleFactor = row.GetItem(query.ShdwScaleFactor);
            cells.ShdwType = row.GetItem(query.ShdwType).ToInt();
            cells.UIVisibility = row.GetItem(query.UIVisibility);
            cells.XGridDensity = row.GetItem(query.XGridDensity);
            cells.XGridOrigin = row.GetItem(query.XGridOrigin);
            cells.XGridSpacing = row.GetItem(query.XGridSpacing);
            cells.XRulerDensity = row.GetItem(query.XRulerDensity);
            cells.XRulerOrigin = row.GetItem(query.XRulerOrigin);
            cells.YGridDensity = row.GetItem(query.YGridDensity);
            cells.YGridOrigin = row.GetItem(query.YGridOrigin);
            cells.YGridSpacing = row.GetItem(query.YGridSpacing);
            cells.YRulerDensity = row.GetItem(query.YRulerDensity);
            cells.YRulerOrigin = row.GetItem(query.YRulerOrigin);
            cells.AvenueSizeX = row.GetItem(query.AvenueSizeX);
            cells.AvenueSizeY = row.GetItem(query.AvenueSizeY);
            cells.BlockSizeX = row.GetItem(query.BlockSizeX);
            cells.BlockSizeY = row.GetItem(query.BlockSizeY);
            cells.CtrlAsInput = row.GetItem(query.CtrlAsInput).ToInt();
            cells.DynamicsOff = row.GetItem(query.DynamicsOff).ToInt();
            cells.EnableGrid = row.GetItem(query.EnableGrid).ToInt();
            cells.LineAdjustFrom = row.GetItem(query.LineAdjustFrom).ToInt();
            cells.LineAdjustTo = row.GetItem(query.LineAdjustTo);
            cells.LineJumpCode = row.GetItem(query.LineJumpCode);
            cells.LineJumpFactorX = row.GetItem(query.LineJumpFactorX);
            cells.LineJumpFactorY = row.GetItem(query.LineJumpFactorY);
            cells.LineJumpStyle = row.GetItem(query.LineJumpStyle).ToInt();
            cells.LineRouteExt = row.GetItem(query.LineRouteExt);
            cells.LineToLineX = row.GetItem(query.LineToLineX);
            cells.LineToLineY = row.GetItem(query.LineToLineY);
            cells.LineToNodeX = row.GetItem(query.LineToNodeX);
            cells.LineToNodeY = row.GetItem(query.LineToNodeY);
            cells.PageLineJumpDirX = row.GetItem(query.PageLineJumpDirX);
            cells.PageLineJumpDirY = row.GetItem(query.PageLineJumpDirY);
            cells.PageShapeSplit = row.GetItem(query.PageShapeSplit).ToInt();
            cells.PlaceDepth = row.GetItem(query.PlaceDepth).ToInt();
            cells.PlaceFlip = row.GetItem(query.PlaceFlip).ToInt();
            cells.PlaceStyle = row.GetItem(query.PlaceStyle).ToInt();
            cells.PlowCode = row.GetItem(query.PlowCode).ToInt();
            cells.ResizePage = row.GetItem(query.ResizePage).ToInt();
            cells.RouteStyle = row.GetItem(query.RouteStyle).ToInt();
            return cells;
        }
