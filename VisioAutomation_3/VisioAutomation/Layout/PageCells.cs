...
namespace VisioAutomation.Layout
{
    public partial class PageCells : VA.ShapeSheet.CellDataGroup
    {
        ...
        private static PageCells get_cells_from_row(PageQuery query, VA.ShapeSheet.Query.QueryDataSet<double> qds, int row)
        {
            ...
            cells.OnPage = qds.GetItem(row, query.OnPage).Cast(v => (int)v);
            ...
            cells.PaperKind = qds.GetItem(row, query.PaperKind).Cast(v => (int)v);
            cells.PrintGrid = qds.GetItem(row, query.PrintGrid).Cast(v => (int)v);
            cells.PrintPageOrientation = qds.GetItem(row, query.PrintPageOrientation).Cast(v => (int)v);
            cells.ScaleX = qds.GetItem(row, query.ScaleX);
            cells.ScaleY = qds.GetItem(row, query.ScaleY);
            cells.PaperSource = qds.GetItem(row, query.PaperSource).Cast(v => (int)v);
            cells.DrawingScale = qds.GetItem(row, query.DrawingScale);
            cells.DrawingScaleType = qds.GetItem(row, query.DrawingScaleType).Cast(v => (int)v);
            cells.DrawingSizeType = qds.GetItem(row, query.DrawingSizeType).Cast(v => (int)v);
            cells.InhibitSnap = qds.GetItem(row, query.InhibitSnap).Cast(v => (int)v);
            ...
            cells.ShdwType = qds.GetItem(row, query.ShdwType).Cast(v => (int)v);
            ...
            cells.CtrlAsInput = qds.GetItem(row, query.CtrlAsInput).Cast(v => (int)v);
            cells.DynamicsOff = qds.GetItem(row, query.DynamicsOff).Cast(v => (int)v);
            cells.EnableGrid = qds.GetItem(row, query.EnableGrid).Cast(v => (int)v);
            cells.LineAdjustFrom = qds.GetItem(row, query.LineAdjustFrom).Cast(v => (int)v);
            ...
            cells.LineJumpStyle = qds.GetItem(row, query.LineJumpStyle).Cast(v => (int)v);
            ...
            cells.PageShapeSplit = qds.GetItem(row, query.PageShapeSplit).Cast(v => (int)v);
            cells.PlaceDepth = qds.GetItem(row, query.PlaceDepth).Cast(v => (int)v);
            cells.PlaceFlip = qds.GetItem(row, query.PlaceFlip).Cast(v => (int)v);
            cells.PlaceStyle = qds.GetItem(row, query.PlaceStyle).Cast(v => (int)v);
            cells.PlowCode = qds.GetItem(row, query.PlowCode).Cast(v => (int)v);
            cells.ResizePage = qds.GetItem(row, query.ResizePage).Cast(v => (int)v);
            cells.RouteStyle = qds.GetItem(row, query.RouteStyle).Cast(v => (int)v);
            return cells;
        }
