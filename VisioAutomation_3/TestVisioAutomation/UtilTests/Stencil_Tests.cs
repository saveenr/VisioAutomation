...
namespace TestVisioAutomation
{
    ...
    public class StencilTests : VisioAutomationTest
    {
        ...
        public void RackMountedEquipment_1()
        {
            ...
            CustomPropertyHelper.SetCustomProperty(rack_shape, "UCount", total_height.ToString());
            ...
            foreach (var item in items)
            {
                ...
                CustomPropertyHelper.UpdateCustomProperty(shape1, "UCount", item.ucount.ToString());
